      ...
      <div className="container my-5 mt-5 h-100 md:mt-[15vh]">
        ...
        <div className="prose ml-5">
          <ul className="mb-5 text-xl list-decimal" role="list">
            ...
            <li>
              If an employee does not achieve the target of 10 tests, a
              deduction of 500 takas will be applied for each test not completed
              from their monthly commission. If the employee does not have a
              monthly commission, the deduction will be made from their regular
            ...
            <li>
              Marketing employees will receive commissions every 4 months,
              solely based on regular client&apos;s contributions (irregular or
              quarterly-based not applicable), such as ITS, WoodWood, THOD.
            </li>
            <li>
              Monthly incentives will be granted based on performance in 10
              tests, and the best seller will be recognized.
            </li>
            <li>
        ...
        <p className="font-mono text-xl">
          ...
          coffee/tea, games, and loud conversations. Disruptive behaviour may
          lead to immediate unpaid leave.
        </p>
